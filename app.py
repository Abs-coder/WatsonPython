...
openai.api_key ="sk-proj-B6qmHagZKVGLXZzje9oZT3BlbkFJYsDFd58p6roMjqb2SOmk"
...
def process_input(user_input):
    ...
    if user_input.lower() == "help":
    ...
    elif user_input.lower() in ["how are you?", "how are you"]:
        return "Hey! I am good, what about you?"
    elif user_input.lower() in ["what is oms?"]:
        return "OMS stands for Order Management System. It is a software system that automates the process of managing orders."
        ...
        # Query OpenAI GPT-3 for more complex responses
        try:
            ...
            # Fallback to Google Custom Search API if OpenAI API fails
            url = f"https://www.googleapis.com/customsearch/v1"
            params = {
                "q": user_input,
                "cx": cse_id,
